...
!LuxTestUtils.ENZYME_TESTING_ENABLED) begin
    ...
    _, _,
    _, tstate_new=@inferred Training.compute_gradients(AutoEnzyme(), mse, (x, x), tstate)
    ...
    _, _,
    _,
    tstate_new2=@inferred Training.compute_gradients(AutoEnzyme(), mse2, (x, x), tstate_new)
